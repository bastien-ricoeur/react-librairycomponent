...
const PieChartSkeletonCard = ({ labelFontSize }: PieChartSkeletonCardProps) => {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            className={`${classes.skeletonAnimation} ${classes.firstChartMask}`}
          ></div>
          <div
            className={classes.secondChartMask}
            style={{
              width: widthOfCenter,
              height: widthOfCenter,
              top: paddingOfCenter,
              left: paddingOfCenter,
            }}
          ></div>
        </div>
      </div>
